...
<input type="checkbox" id="css3menu-switcher" class="switchbox"><label onclick="" class="switch" for="css3menu-switcher"></label>	<li class="topfirst" id="inicio1"><a href="Home.php" style="height:19px;line-height:19px;"><img src="data:image/png;base64," alt=""/>Inicio</a></li>
	...
	<h3 class="encabezado">Complete los datos del nuevo expediente del trabajador alumno</h3>
	...
	<div id="exito" >
		<b><img src="../images/dialog-warning.png"/> Estudiante adicionado satisfactoriamente</b>
	</div>
	 
	<table align="center" border="0" cellpadding="0" cellspacing="0">
<tr><td>

<form action="../php/form3_proc.php" method="POST" enctype="multipart/form-data">
  <input type='hidden' name="issubmit" value="1">
<!-- Tabs -->
  		<div id="wizard" class="swMain" style="marging-left:25px">
  			<ul>
  				<li><a href="#step-1">
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input id="apellidos" name="apellidos" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input id="ci" name="ci" value="" type=number class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type=date id="nacimiento" name="nacimiento" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
						  ...
						  <option value="Municipio especial">Municipio especial</option>   
						  </select>
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <select id="escolaridad" name="escolaridad" class="select">
                          <option value="">-Seleccione-</option>
					...
					<tr>
                    	...
                    	<td align="left">
                        <select id="especialidadEstudio" name="especialidadEstudio" class="select">
                          <option value="">-Seleccione-</option>
                          <option value="Bibliotecologia">Bibliotecologia</option>
                          <option value="Informatica">Informatica</option>                 
						  <option value="Gestion Documental">Gestion Documental</option>
                          <option value="Sede Universitaria">Sede Universitaria</option>                 
                        </select>
                      </td>
					...
					<tr>
                        ...
                        <select id="cursoMatricula" name="cursoMatricula" class="select">
                          ...
                          <option value="4to Curso">4to Curso</option>                 
                        </select>
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input id="procedencia" name="procedencia" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input id="comprobante" name="comprobante" value="" type=number class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input id="hijos" name="hijos" value="" type=number class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
						  ...
						  <input type="file" name="foto" id="foto" readonly=true>
                      </td>
            ...
            <table cellspacing="3" cellpadding="3" align="center">
					...
					<tr>
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="calle" name="calle" value="" class="input">
                      </td>
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="numero" name="numero" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="entrecalles" name="entrecalles" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="piso" name="piso" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="apto" name="apto" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="barrio" name="barrio" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="telefono" name="telefono" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="nombrecentro" name="nombrecentro" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="direccioncentro" name="direccioncentro" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="organismocentro" name="organismocentro" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="cargo" name="cargo" value="" class="input">
                      </td>
					...
					<tr>
                    	<td align="right"><label>Teléfono :</label></td>
                    	<td align="left">
                    	  <input type="text" id="telefonocentro" name="telefonocentro" value="" class="input">
                      </td>
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input type="number" id="annoMatriculado" name="annoMatriculado" value="" class="input">
                      </td>
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="nombreCentroEstudio" name="nombreCentroEstudio" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="regional" name="regional" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="text" id="expedienteNumero" name="expedienteNumero" value="" class="input">
                      </td>
					...
					<tr>
                    	...
                    	<td align="left">
                    	  <input type="date" id="fechaIngreso" name="fechaIngreso" value="" class="input">
                      </td>
          			...
          			<tr>
                    	...
                    	<td align="left">
                            <textarea name="complementario" id="complementario" class="textarea" rows="3"></textarea>
                      </td>
